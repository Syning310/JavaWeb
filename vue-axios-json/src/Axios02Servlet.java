...
public class Axios02Servlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 假设 user 是从数据库中查找出来的，现在将其转换成 json 格式的字符串，然后响应给客户端
        String userJsonStr = gson.toJson(user);
        
        response.setCharacterEncoding("utf-8");
        response.setContentType("application/json;charset=utf-8"); // 告诉客户端我们发送的类型
        
        response.getWriter().write("json:" + userJsonStr);
